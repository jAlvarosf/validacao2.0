...
<div class="row justify-content-center">
    <div class="col-md-8">
        <h2>Livros</h2>
        <a href="{{action('LivroController@create')}}" class="btn btn-primary">Criar</a>
        ...
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><img src= {{$livro->imagem}} style="width:150px; height:150px; float:left;; marggin-right:25px;" alt=""/></td>
